...
import WithdrawModalCryptoBridge from "./WithdrawModalCryptoBridge";
...
class CryptoBridgeGatewayDepositRequest extends React.Component {
    ...
    componentWillMount() {
        ...
        let receive_address;
        if (this.props.deposit_coin_type !== 'bridge.smart') {
            ...
            return (
                <div style={{padding: "10px 0", fontSize: "1.1rem", fontWeight: "bold"}}>
                    <table className="table">
                        <tbody>
                            <tr>
                                <td><Translate content="gateway.deposit_login" /></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
    ...
    render() {
        ...
        let emptyRow = <div><LoadingIndicator type="three-bounce"/></div>;
...
export default BindToChainState(CryptoBridgeGatewayDepositRequest, {keep_updating:true});
